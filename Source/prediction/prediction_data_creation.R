...
#s <- sample(1:145231, 145231)[1:90000]
...
#data_numeric = rbind(data_numeric1,data_numeric2,data_numeric3,data_numeric4,data_numeric5,data_numeric6)
#remove(data_numeric1, data_numeric2,data_numeric3,data_numeric4,data_numeric5,data_numeric6)
...
#mydata <- mydata[,-which(colnames(mydata) %in% collist$cols_factors)]
